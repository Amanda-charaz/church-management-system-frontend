  ...
  return (
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{ color: 'white', fontWeight: 'bold', letterSpacing: '2px', fontSize: '14px' }}>
        ...
        <div style={{ width: '100%', maxWidth: '560px' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '40px', color: 'white' }}>
            ...
            <p style={{ color: '#aac4e0', fontSize: '16px', margin: 0 }}>
              Share your prayer needs with us. Our pastors pray over every request.
            </p>
          </div>
          ...
          {submitted ? (
            <div style={{
              ...
              <p style={{ color: '#aac4e0', lineHeight: 1.7, marginBottom: '32px' }}>
                Our pastors will be praying for you. May God's grace and peace be with you.
              </p>
            ...
            <div style={{
              ...
              <form onSubmit={handleSubmit}>
                <div style={{ marginBottom: '20px' }}>
                  <label style={{ display: 'block', marginBottom: '8px', color: 'white', fontSize: '14px', fontWeight: 'bold' }}>
                    Your Name <span style={{ color: '#aac4e0', fontWeight: 'normal' }}>(optional — leave blank to stay anonymous)</span>
                  </label>
                  <input
                    type="text"
              ...
              <p style={{ color: '#aac4e0', fontSize: '13px', textAlign: 'center', marginTop: '20px', marginBottom: 0 }}>
                All prayer requests are handled with care and confidentiality.
              </p>
            </div>
          )}
        </div>
